...
const getAllSemester = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    //   paginationOptions
    // )
    const result = yield academicSemester_service_1.AcademicSemesterService.getAllSemester(paginationOptions, filters);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
...
const getSingleSemester = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
